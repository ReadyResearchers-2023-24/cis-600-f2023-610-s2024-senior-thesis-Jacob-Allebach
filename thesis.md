...
are essential to understanding how the program and underlying algorithms function, where
some of the later ones will be much more focused on a particular aspect of map generation.
Additionally, some resources are only tangentially related to this program, but they are
...
## Unity
  ...
  The Unity engine is the piece of software that really allows this program to exist in
